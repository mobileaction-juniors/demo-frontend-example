...
<template>
  <div class="ma-keywords-generator p-4">
      ...
      <MaInput id="allwords" v-model:value="inputText" type="textarea" hint-text="Please select how you want to see n-grams and don't forget to use ',' for different excluded words." class="input-area resize-none w-full p-2 mb-1" style="resize: none;"></MaInput>
      ...
      <MaButton class="submit-button mb-4 w-full md:w-auto transition-all duration-500 ease-in-out" type="primary" variant="dark" icon="tick" @click="generateNGrams">Submit</MaButton>
